        ...
        <View style={styles.container}>
              ...
              return (
                <View
                  style={{
                    ...
                    backgroundColor:
                      currentStep === index ? "#043c85" : "#d9dee3",
                  }}
                  key={index}
                ></View>
              );
          ...
          <View style={styles.navigationView}>
            {currentStep > 0 ? (
              ...
              >
                <Text style={styles.navigationBtnTxt}>
                  <FontAwesome name="arrow-left" size={30} color="#043c85" />
                </Text>
              </TouchableOpacity>
            ) : (
              <View></View>
            ...
            {currentStep === steps.length - 1 ? (
              <TouchableOpacity
                onPress={() => navigation.navigate("Dialysis")}
                style={{
                  ...styles.navigationBtn,
              ...
              >
                <Text style={styles.navigationBtnTxt}>
                  <FontAwesome name="arrow-right" size={30} color="#043c85" />
                </Text>
              </TouchableOpacity>
            )}
          </View>
